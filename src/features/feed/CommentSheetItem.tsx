...
export function CommentSheetItem({
  ...
  return (
    <li className={`comment-sheet-item${isReply ? ' is-reply' : ''}${actionMenuOpen ? ' has-action-menu' : ''}`}>
      {editing ? (
        <div className="comment-sheet-edit">
          <input
            value={editText}
            ...
            autoFocus
          />
          <div className="comment-sheet-edit-actions">
            <button type="button" className="comment-action-btn" onClick={onSaveEdit}>
              저장
            </button>
            <button type="button" className="comment-action-btn" onClick={onCancelEdit}>
              취소
            </button>
          </div>
        </div>
        ...
        <div className="comment-sheet-row">
          ...
          >
            {comment.replyTo ? (
              <span className="comment-reply-tag">@{comment.replyTo}에게 답글</span>
            ) : null}
