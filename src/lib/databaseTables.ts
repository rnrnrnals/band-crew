...
export const DB_TABLES = {
  ...
  practiceSessionLikes: 'practice_session_likes',
  practiceSessionComments: 'practice_session_comments',
  practiceSessionCommentLikes: 'practice_session_comment_likes',
  practiceTrackLikes: 'practice_track_likes',
  practiceTrackComments: 'practice_track_comments',
  practiceTrackCommentLikes: 'practice_track_comment_likes',
